...
zokou({ nomCom: "intro", categorie: "General" }, async (dest, zk, commandeOptions) => {
 ...
 *STEPS TO GET SESSION*
 ...
 4. Tap on that notification then enter in the code that matelee tech sent you.
